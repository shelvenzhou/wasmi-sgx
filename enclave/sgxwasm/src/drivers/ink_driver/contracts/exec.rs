...
use crate::{
    ...
    BalanceOf, CodeHash, Config, ConfigCache, ContractInfo, ContractInfoOf, Error, Event,
    Module as Contracts, RawEvent, TrieId,
};
use frame_support::{
    ...
    L: Loader<T, Executable = E>,
{
    ...
    fn instantiate(
        ...
        self.ctx
            .instantiate(endowment, gas_meter, code_hash, input_data, salt)
    }
